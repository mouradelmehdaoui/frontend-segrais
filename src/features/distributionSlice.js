...
export const fetchDistributions = createAsyncThunk("distribution/fetch", async () => {
  const res = await axios.get("https://backend-segrais.vercel.app/api/distribution");
  return res.data;
});

// delete
export const deleteDistribution = createAsyncThunk("distribution/delete", async id => {
  await axios.delete(`${"https://backend-segrais.vercel.app/api/distribution"}/${id}`);
  return id;
});
...
export const createDistribution = createAsyncThunk(
  "distribution/create",
  async (data) => {
    const res = await axios.post("https://backend-segrais.vercel.app/api/distribution", data);
    return res.data;
  }
);
...
export const updateDistribution = createAsyncThunk(
  "distribution/update",
  async ({ id, data }) => {
    const res = await axios.put(`${"https://backend-segrais.vercel.app/api/distribution"}/${id}`, data);
    return res.data;
  }
);
